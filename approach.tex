...
%In what follows, $\mathbf{L}$ is chosen to be the canonical basis $\mathbf{I_3}$ for the Cartesian lattice, whereas for the BCC lattice, we choose $\mathbf{L = L}_B$.

\subsection{Divergence of $\vec{V}(\vx)$}
